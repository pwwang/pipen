...
### custom runner
Yes, you can write your own runners, just write a class (i.e. `runner_custom`) extending `runner_local`, put the file in `runners` and register it before use (`proc.registerRunner('custom')`). 
