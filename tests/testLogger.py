...
class TestLogger (unittest.TestCase):
	...
	def testLogfile (self):
		...
		with open(logfile) as f:
			...
			self.assertTrue('You don\'t see this1' in logs)
			self.assertTrue('But you see this2' in logs)
			self.assertTrue('You see this3' in logs)
			self.assertTrue('You see this4' in logs)
			self.assertTrue('You see this5' in logs)
			self.assertTrue('You see this6' in logs)
			self.assertTrue('You see this7' in logs)
			self.assertTrue('You see this8' in logs)
			self.assertTrue('You see this9' in logs)
			self.assertTrue('You see this10' in logs)
			self.assertTrue('You see this11' in logs)
			self.assertTrue('You see this12' in logs)
			self.assertTrue('You see this13' in logs)
			self.assertTrue('You see this14' in logs)
			self.assertTrue('You see this15' in logs)
			self.assertTrue('You see this16' in logs)
			self.assertTrue('You see this17' in logs)
			self.assertTrue('You don\'t see this18' in logs)
