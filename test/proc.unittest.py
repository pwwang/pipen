...
class TestProc (unittest.TestCase):
	...
	def testRegisterRunner (self):
		testfile = os.path.join(rootdir, 'runners', 'runner_test.py')
		with open(testfile, 'w') as f:
			f.write ("""from runner_local import runner_local
...
"""			)
	...
	def testBuildScript(self):
		...
		tplfile = os.path.join (rootdir, 'test', 'script.tpl')
